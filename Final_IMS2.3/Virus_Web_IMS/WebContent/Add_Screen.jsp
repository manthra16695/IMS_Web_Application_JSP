...
<head>
    ...
    <!-- Title Page-->
    <title>Add an inventory into VIRUS IMS</title>
...
<div class="w3-sidebar w3-bar-block w3-light-grey" style="width: 10%">
		...
		<img src="https://www.w3schools.com/w3css/img_snowtops.jpg" alt="Snow"
			...
			href="Add_Screen.jsp"  class="w3-bar-item w3-button w3-red"> <img src="https://img.icons8.com/ios/50/000000/add.png" style="height: 30px"/> Add </a>
        ...
        <div class="wrapper wrapper--w900">
            ...
            <div class="card card-6">
                ...
                <div class="card-heading">
                    <h2 class="title">Add an inventory into VIRUS IMS </h2>
                </div>
                <div class="card-body">
                 
                 <% 
                 try{
                    if (request.getParameter("added").equals("1")) 
                    { 
                %>
                ...
                <% }}catch(Exception e){} %>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <input class="input--style-6" type="text" name="prcode">
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="text" name="prname">
                                </div>
                            </div>
                        </div>
			<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="text" name="model">
                                </div>
                            </div>
                        </div>
			...
			<div class="form-row">
                            ...
                            <div class="value">
                                <input class="input--style-6" type="text" name="type">
                            </div>
                        </div>
			<div class="form-row">
			...
			<div class="form-row">
                            <div class="name">MSRP</div>
                            <div class="value">
                                <input class="input--style-6" type="text" name="msrp">
                            </div>
                        </div>
			<div class="form-row">
                            <div class="name">Unit Price</div>
                            <div class="value">
                                <input class="input--style-6" type="text" name="unitprice">
                            </div>
                        </div>
			<div class="form-row">
                            <div class="name">Discount</div>
                            <div class="value">
                                <input class="input--style-6" type="text" name="discount">
                            </div>
                        </div>
			<div class="form-row">
                            <div class="name">Quantity</div>
                            <div class="value">
                                <input class="input--style-6" type="text" name="quantity">
                            </div>
                        </div>
                ...
                <div class="card-footer">
                	...
                	<!--  <button href="AccessPage.html" class="btn btn--radius-2 btn--blue-2" type="Return">Return</button>-->
		             <button class="btn btn--radius-2 btn--blue-2" type="submit">Submit</button>
		             <button class="btn btn--radius-2 btn--blue-2" type="submit"><a href="AccessPage.html"> Return</a></button>
